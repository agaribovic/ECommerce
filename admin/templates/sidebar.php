...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link <?php echo ($page == '' || $page == 'index.php') ? 'active' : ''; ?>" href="index.php">
              ...
              Admini <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Cao <?php echo $_SESSION["admin_name"]; ?></h1>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <button type="button" class="btn btn-sm btn-outline-secondary">Uvoz</button>
            <button type="button" class="btn btn-sm btn-outline-secondary">Izvoz</button>
          </div>
