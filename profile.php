	...
	<div class="navbar navbar-inverse navbar-fixed-top" style="z-index:9999; position:absolute; top:0%; left:70%; background-color:black; width: 500px;">
		<div class="container-fluid" >	
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span><?php echo "Zdravo,".$_SESSION["name"]; ?></a>
					<ul class="dropdown-menu">
						<li><a href="cart.php" style="text-decoration:none; color:pink;"><span class="glyphicon glyphicon-shopping-cart" style="color:pink">Korpa</a></li>
						<li class="divider"></li>
						<li><a href="logout.php" style="text-decoration:none; color:pink;">Odjavi se</a></li>
					</ul>
				</li>
			</ul>
		</div>
...
<div class="torta1" style="width: 1800px; position:relative; left: -20px; z-index:-9999; margin-left:70px;">
