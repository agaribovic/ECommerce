...
function uspjesnaKupovina() {
	alert("Zahvaljujemo se, uspješna kupovina!");
}
...
if(isset($_POST["category"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h4>Kategorije</h4></a></li>
	";
...
if(isset($_POST["brand"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h4>Sastojci</h4></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$bid = $row["brand_id"];
	...
	if (isset($_POST["checkOutDetails"])) {
		if (mysqli_num_rows($query) > 0) {
			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					echo '<input type="submit" style="float:right; background-color:pink; width: 100px; margin-right: 50px;" name="login_user_with_product" class="btn btn-info btn-lg" value="Plati" >
							</form>';
					...
					echo '
						...
						<form method="post">
							...
							echo   
								'<input type="submit" style="float:right; background-color:pink; width: 100px; margin-right: 50px;" name="login_user_with_product" class="btn btn-info btn-lg" value="Plati" onClick=uspjesnaKupovina();>
								</form>';
				}
			}
	}
